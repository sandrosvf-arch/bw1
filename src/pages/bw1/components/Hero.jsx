        ...
        <div className="text-center">
          ...
          <div className="mt-10 max-w-xl mx-auto">
            <div className="relative group">
              <input
                type="text"
                className="block w-full pl-4 pr-10 py-4 border-none rounded-2xl leading-5 bg-white shadow-xl placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-slate-900 sm:text-sm transition-all"
